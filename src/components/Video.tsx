      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        ...
        <div className="flex items-start gap-16">
            ...
            <div className="flex flex-col gap-4">
              <a href="" target="_blank" className="p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-700 transition-colors">
                <DiscordLogo size={24} />
                Comunidade do Discord
              </a>
              <a href="" target="_blank" className="p-4 text-sm border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-gray-900 transition-colors flex items-center rounded font-bold uppercase gap-2 justify-center">
                <Lightning size={24} />
                Acesse o desafio
              </a>
            </div>
